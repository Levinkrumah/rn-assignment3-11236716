...
import { View, Text, ScrollView, TextInput, Button, FlatList, Image, StyleSheet } from 'react-native';
    ...
    <ScrollView style={styles.container}>
      ...
      <ScrollView horizontal>
        {categories.map(category => (
          <CategoryCard key={category.id} title={category.title} tasks={category.tasks} />
        ))}
      </ScrollView>
